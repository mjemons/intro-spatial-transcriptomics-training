...
We will start by loading the normalized `SpatialExperiment` object from the previous exercise, which contains filtered cells, and genes with at least 1 count across all retained cells.
...
<!-- TO DO: launch nnSVGs on the list of top HVGs?)
--->
