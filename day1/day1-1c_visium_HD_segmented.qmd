...
cropped_seg <- seg[seg$rownames %in% base::colnames(spe_seg), ]

base::rownames(cropped_seg) <- base::colnames(spe_seg)

stopifnot(base::rownames(cropped_seg) == cropped_seg$rownames)
