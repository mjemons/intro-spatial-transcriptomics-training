...
spe <- loadHDF5SummarizedExperiment(dir="results/day2", prefix="01.4_spe_")
```
...
```{r}
speMult <- loadHDF5SummarizedExperiment(dir="data/Human_Colon_Cancer_P1/", prefix="02.3_spe_tmp_")
