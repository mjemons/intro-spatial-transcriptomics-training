...
# Libraries
```{r day3-3-differential-spatial-pattern-1}
#| message: false
#| warning: false
#| output: false
...
```{r day3-3-differential-spatial-pattern-2}
spe <- loadHDF5SummarizedExperiment(dir="data/Human_Colon_Cancer_P1/", prefix="02.3_spe_tmp_")
...
```{r day3-3-differential-spatial-pattern-3}
head(colData(spe), 3)
table(spe$condition)
```
...
```{r day3-3-differential-spatial-pattern-4}
#| fig-width: 4
#| fig-height: 4
...
```{r day3-3-differential-spatial-pattern-5}
...
```{r day3-3-differential-spatial-pattern-6}
# Extract gene-level results
...
```{r day3-3-differential-spatial-pattern-7}
#| fig-width: 9
#| fig-height: 9
...
```{r day3-3-differential-spatial-pattern-8}
...
```{r day3-3-differential-spatial-pattern-9}
...
```{r day3-3-differential-spatial-pattern-10}
#| fig-width: 8
#| fig-height: 6
...
```{r day3-3-differential-spatial-pattern-11}
#| eval: false
rm(list = ls())
gc()
.rs.restartR()
